...
# Títol del gràfic
set title "Convergència de la temperatura a (18,12.5) amb Gauss-Seidel"
...
# Plot 
plot "aux2.dat" index 0 using 1:2 with points t "T_i_n_i_c_i_a_l = 6ºC", \
"aux2.dat" index 1 using 1:2 with points t "T_i_n_i_c_i_a_l = 19ºC", \
"aux2.dat" index 2 using 1:2 with points t "T_i_n_i_c_i_a_l = 320ºC"
#pause -1
