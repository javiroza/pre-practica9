...
# Títol del gràfic
set title "Convergència de la temperatura a (18,12.5)"
...
# Plot 
plot "aux1.dat" index 0 using 1:2 with points t "Jacobi", \
"aux1.dat" index 1 using 1:2 with points t "Gauss Seidel"
#pause -1
